<h2 class="section-title"><i class="fas fa-edit"></i>Modifier le Patient</h2>
<div class="card">
    <div class="card-body">
        ...
        <form method="POST">
            ...
            <a href="?section=dossiers" class="btn btn-outline">Annuler</a>
        </form>
        <?php else: ?>
        <p class="text-muted">Patient introuvable.</p>
        <a href="?section=mes_patients" class="btn btn-outline">Retour</a>
        <?php endif; ?>
    </div>
</div>
